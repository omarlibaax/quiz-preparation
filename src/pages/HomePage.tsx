      ...
      <header className="mb-6">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">Choose {selectedLabel} to begin</p>
          </div>
        </div>
      </header>

      <section className="space-y-3">
        <div className="mb-2 rounded-3xl bg-slate-50 p-3 ring-1 ring-slate-100">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            <button
              ...
              onClick={() => {
                ...
                writeJson(PREF_KEY, { ...defaultPrefs, ...current, audienceMode: 'children', lastAudienceMode: 'children' })
              }}
              className={[
            ...
            <button
              ...
              onClick={() => {
                ...
                const current = readJson<Record<string, unknown>>(PREF_KEY, {})
                writeJson(PREF_KEY, { ...defaultPrefs, ...current, audienceMode: 'general', lastAudienceMode: 'general' })
              }}
              className={[
                'rounded-2xl px-3 py-2 text-sm font-semibold ring-1 transition',
