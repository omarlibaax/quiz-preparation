        ...
        <div className="rounded-3xl bg-white p-5 shadow-md ring-1 ring-slate-100">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="text-right">
              <div className="rounded-3xl bg-gradient-to-r from-sky-500 to-indigo-500 px-5 py-4 text-white shadow-sm">
          ...
          <div className="mt-5 rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-100">
            ...
            <div className="mt-3 space-y-3">
              {weakTopics.length === 0 ? (
                ...
                weakTopics.map((t) => (
                  <div key={t.topicName} className="rounded-2xl bg-white p-3 ring-1 ring-slate-100">
                    <div className="flex items-center justify-between">
          ...
          <div className="mt-6 flex gap-3">
            <button
              ...
              className="flex-1 rounded-3xl bg-slate-900 px-4 py-3 text-sm font-extrabold text-white shadow-sm"
            >
              Review Answers
            </button>
            <button
              type="button"
              onClick={() => navigate('/')}
              className="rounded-3xl bg-white px-4 py-3 text-sm font-extrabold text-slate-800 ring-1 ring-slate-200"
            >
              Home
            </button>
          </div>
