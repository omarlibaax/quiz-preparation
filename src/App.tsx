...
export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-600 via-indigo-600 to-sky-500 px-2 py-6 sm:px-4 sm:py-8">
      <div className="relative mx-auto w-full max-w-5xl">
        ...
        <div className="relative overflow-hidden rounded-[2rem] bg-white/90 p-3 shadow-2xl backdrop-blur-sm sm:p-4">
